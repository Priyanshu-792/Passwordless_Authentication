...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 86943cde-d8ed-429b-b4ef-0797cc9218a2
```

> `86943cde-d8ed-429b-b4ef-0797cc9218a2` is the password of the certificate, you can change it to any password you want.
